...
function colormag_scripts_styles_method() {
   ...
   */
   ...
   wp_register_script( 'colormag-bxslider', COLORMAG_JS_URL . '/jquery.bxslider.min.js', array( 'jquery' ), '4.2.10', true );
	...
	wp_enqueue_style( 'colormag-fontawesome', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css', array(), '' );
   ...
   if( get_post_format() || is_archive() || is_search() ) {
	 ...
	 * Seo js file.
	 */
	//wp_enqueue_scripts('seo',COLORMAG_JS_URL.'/seo.js',array( 'jquery' ),'1.0.0',true);
}
...
function colormag_footer_copyright() {
   ...
   $default_footer_value = sprintf( __( 'Copyright &copy %1$s. BẢN QUYỀN THUỘC VỀ KAFEBIT .', 'colormag' ), date( 'Y' ), $site_link ).'<br>';
